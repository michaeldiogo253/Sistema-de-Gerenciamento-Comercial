 ...
 * @author michael
 */
public class TelaBaixoEstoque extends javax.swing.JFrame {

    /**
     * Creates new form TelaBaixoEstoque
     */
    public void listar() {

        VendaDAO dao = new VendaDAO();
        List<Produto> lista = dao.listarProdutoBaixoEstoque();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Produtos ordenados por baixo estoque ");
        ...
        TabelaProdutosMaisVendidos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Produto", "Qtd. Estoque", "Preço", "Descrição"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaBaixoEstoque.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaBaixoEstoque().setVisible(true);
            }
        });
    }
