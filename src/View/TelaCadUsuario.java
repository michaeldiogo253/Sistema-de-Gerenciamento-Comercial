...
public class TelaCadUsuario extends javax.swing.JFrame {
    ...
    private void TabelaUsuarioMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TabelaUsuarioMouseClicked
        ...
        txtLogin.setText(TabelaUsuario.getValueAt(TabelaUsuario.getSelectedRow(), 8).toString());
        txtSenha.setText(TabelaUsuario.getValueAt(TabelaUsuario.getSelectedRow(), 9).toString());
        ...
        if ((txtSenha.getText().equals(txtConSenha.getText())) && (!"".equals(txtSenha.getText())) && (!txtNome.getText().equals(""))) {
            ...
            while (true) {
                if (!txtSenha.getText().equals(txtConSenha.getText()) || ("".equals(txtSenha.getText()))) {
                    txtSenha.setText("");
                    txtConSenha.setText("");
                    JOptionPane.showMessageDialog(rootPane, "Senhas Cadastradas estão diferentes ou em branco, digite novamente ...");
                    break;
                }
                if (txtLogin.getText().equals("")) {
                    JOptionPane.showMessageDialog(null, "Campo Usuario Login esta em branco ! ");
                    break;
                }
    ...
    private void btnPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesquisarActionPerformed
        ...
        UsuarioDAO dao = new UsuarioDAO();
        List<Usuario> lista = dao.buscaClientePorNome(nome);
        DefaultTableModel dados = (DefaultTableModel) TabelaUsuario.getModel();
        dados.setNumRows(0);
